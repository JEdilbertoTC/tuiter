<div class="col-xl-6 col order-first order-xl-last col-md-12">
    ...
    <div class="suggestions">
        <div class="border p-3">
			...
			<?php
			$query = "SELECT u.name, p.id, p.info, p.date, u.photo, u.email, u.id AS id_user FROM publicaciones p INNER JOIN usuarios u ON u.id = p.id_user ORDER BY RAND() LIMIT 3";
				...
				if (isset($_SESSION['id'])) {
					if ($randomPost['id'] != $_SESSION['id']) { ?>
                        <div class="pe-2 d-flex mt- w-100 suggestion mt-2"
                             style="border-radius: 50px; transition: all .5s ease">
                            <div class="pe-3">
                            ...
                            <div class="d-flex flex-column w-100">
                                <a class="mb-2" href="profile.php?id=<?php echo $randomPost['id'] ?>">
                                    <p class="profile"
                                       style="padding-right: 2px; padding-left: 2px"><?php echo $randomPost['name']; ?></p>
                                    <p class="email"
